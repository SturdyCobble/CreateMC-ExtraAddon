...
public class ObsidianDrillRenderer extends KineticTileEntityRenderer {

	public ObsidianDrillRenderer(TileEntityRendererDispatcher dispatcher) {
		super(dispatcher);
	}
	
	@Override
	protected SuperByteBuffer getRotatedModel(KineticTileEntity te) {
		return ModBlockPartials.OBSIDIAN_DRILL_HEAD.renderOnDirectional(te.getBlockState());
	}

	protected static SuperByteBuffer getRotatingModel(BlockState state) {
		return ModBlockPartials.OBSIDIAN_DRILL_HEAD.renderOnDirectional(state);
	}
	...
	public static void renderInContraption(MovementContext context, MatrixStack ms, MatrixStack msLocal,
		...
		SuperByteBuffer superBuffer = ModBlockPartials.OBSIDIAN_DRILL_HEAD.renderOnDirectional(state);
