...
public class ModItems {
	...
	public static final RegistryObject<BlockItem> GEOTHERMAL_FAN = ITEMS.register("geothermal_fan", () -> new BlockItem(ModBlocks.GEOTHERMAL_FAN.get(), new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
	public static final RegistryObject<BlockItem> OBSIDIAN_DRILL = ITEMS.register("obsidian_drill", () -> new BlockItem(ModBlocks.OBSIDIAN_DRILL.get(), new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
	public static final RegistryObject<BlockItem> BEDROCK_ANVIL = ITEMS.register("bedrock_anvil", () -> new BlockItem(ModBlocks.BEDROCK_ANVIL.get(), new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
	public static final RegistryObject<BlockItem> COMPACT_WOOL = ITEMS.register("compact_wool", () -> new BlockItem(ModBlocks.COMPACT_WOOL.get(), new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
	public static final RegistryObject<BlockItem> BEDROCK_SLATE = ITEMS.register("bedrock_slate", () -> new BlockItem(ModBlocks.BEDROCK_SLATE.get(), new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
